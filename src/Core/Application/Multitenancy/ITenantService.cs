...
public interface ITenantService
{
    ...
    Task<CurrentTenantDto> GetCurrentAsync();
    Task<string> CreateAsync(CreateTenantRequest request, CancellationToken cancellationToken);
    Task<string> UpdateAsync(string id, UpdateTenantRequest request, CancellationToken cancellationToken);
    Task<string> UpdateCurrentAsync(UpdateCurrentTenantRequest request, CancellationToken cancellationToken);
