...
public class NotificationSender : INotificationSender
{
    ...
    public Task SendToGroupWithTargetAsync(INotificationMessage notification, string group, string target, CancellationToken cancellationToken) =>
        _notificationHubContext.Clients.Group(group)
            .SendAsync(target, notification, cancellationToken);
